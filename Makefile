...
testa0:
	...
	touch /tmp/sda
	time ./ddplus /tmp ext sam 0x5a5a5a5a 0xa5a5a5a5 4000000000 ext 1024 0xa5
	mv /tmp/sda /tmp/sda.1024
	touch /tmp/sda
	time ./ddplus /tmp ext sam 0x5a5a5a5a 0xa5a5a5a5 4000000000 ext 4096 0xa5
	mv /tmp/sda /tmp/sda.4096
	touch /tmp/sda
	time ./ddplus /tmp ext sam 0x5a5a5a5a 0xa5a5a5a5 4000000000 ext 8192 0xa5
...
testa1:
	...
	touch /tmp/sda
	time ./ddplus /tmp extr sam 0x5a5a5a5a 0xa5a5a5a5 2000001000 extr 8192 423
	rm /tmp/sdb
	touch /tmp/sdb
	time ./ddplus /tmp sam ext 0x5a5a5a5a 0xa5a5a5a5 2000001000 extr 8192 423
...
testa2:
	...
	touch /tmp/sda
	echo "TESTA2:Encode..."
	time ./ddplus /tmp ext sam 0x5a5a5a5a 0xa5a5a5a5 2000000000 ext 8192 191717
	rm /tmp/sdb
	touch /tmp/sdb
	time ./ddplus /tmp sam ext 0x5a5a5a5a 0xa5a5a5a5 2000000000 sam 8192 191717
	echo "TESTA2:md5sums should not match below"
	md5sum /tmp/sdb /tmp/sdb.orig
	rm /tmp/sdb
	touch /tmp/sdb
	time ./ddplus /tmp sam ext 0x5a5a5a5a 0xa5a5a5a5 2000000000 ext 8192 191717
